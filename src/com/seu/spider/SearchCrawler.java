...
//		if (args.length != 3) {
//			System.out
//					.println("Usage:javaSearchCrawler startUrl maxUrl searchString");
//			return;
//		}
//		int max = Integer.parseInt(args[1]);
//		SearchCrawler crawler = new SearchCrawler(args[0], max, args[2]);
		int max = 5;
		SearchCrawler crawler = new SearchCrawler("http://192.168.1.112:8800/", 5, "Apache Tomcat Examples");
